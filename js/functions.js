...
// and stores it in a variable named random
     ...
     */
    let userBill = parseFloat(prompt("What is the bill total?"))
    let userTip = parseFloat(prompt("What percentage would you like to tip? (ex 0.20)"))
    alert("Your total amount is $" + calculateTip(userTip, userBill))
